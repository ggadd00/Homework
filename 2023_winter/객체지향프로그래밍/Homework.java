...
// 3. 인터페이스구현
interface Calculator { // 인터페이스 정의 덧셈,뺄셈,곱셉,나눗셈 선언
...
public class CalculatorApp { //메인 클래스,기본 클래스
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("calculator_results.ser"))) {
            ...
            double num2 = scanner.nextDouble(); //사용자에게 계산할 숫자 2개 입력 받기

            for (String operator : operators) { // 연산자를 반복하고 계산을 수행하여 저장
